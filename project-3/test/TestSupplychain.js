...
=======
    ...
    it("Test that roles are correctly added to contract", async() => {
        ...
        var AddingRetailer = await supplyChain.addRetailer(retailerID);
        truffleAssert.eventEmitted(AddingRetailer, 'AddingRetailer');

        var AddingConsumer = await supplyChain.addConsumer(consumerID);
        truffleAssert.eventEmitted(AddingConsumer, 'AddingConsumer');
    });
...
<<<<<<< HEAD
        ...
        await supplyChain.processItem(_upc, { from: originFarmerID });
...
<<<<<<< HEAD
        ...
        await supplyChain.packItem(_upc, { from: originFarmerID });

        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferOne = await supplyChain.fetchItemBufferOne.call(_upc);
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(_upc);
...
<<<<<<< HEAD
        ...
        var event = supplyChain.sellItem();
        await event.watch((err, res) => {
            eventEmitted = true;
        });
...
<<<<<<< HEAD
        ...
        var event = supplyChain.shipItem();
        await event.watch((err, res) => {
            eventEmitted = true;
        });
...
=======
        ...
        // Verify the result set:
        assert.equal(resultBufferOne[1], sku, 'Error: Invalid item SKU');
        assert.equal(resultBufferOne[1], upc, 'Error: Invalid item UPC');
...
=======
        ...
        // Verify the result set:
        assert.equal(resultBufferTwo[1], sku, 'Error: Invalid item SKU');
